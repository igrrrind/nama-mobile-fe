...
export default function AdminSidebar() {
  ...
  const menuGroups: MenuGroup[] = [
    ...
    },
    {
      ...
      items: [
        { href: "/admin/mau-thiet-bi", label: "Mẫu thiết bị", icon: Package },
      ],
    },
    {
      title: "Quản lý kho",
    ...
    {
      title: "Đăng bài viết",
      items: [{ href: "/admin/bai-viet", label: "Bài viết", icon: Newspaper }],
    },
    {
      title: "Giao diện",
      items: [
    ...
    {
      title: "Hệ thống",
      items: [{ href: "/admin/cai-dat", label: "Cài đặt", icon: Settings }],
    },
  ];

  return (
    <aside className={`${collapsed ? 'w-20' : 'w-64'} bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transition-all duration-300 h-screen`}>
